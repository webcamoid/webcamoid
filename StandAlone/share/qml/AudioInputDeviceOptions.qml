...
Dialog {
    id: deviceOptions
    title: qsTr("Audio Input Settings")
    ...
    onVisibleChanged: {
        ...
        var supportedFormats = audioInputs.supportedFormatsVariant
        ...
        var supportedChannelLayouts =
                audioInputs.supportedChannelLayoutsVariant
        ...
        var supportedSampleRates = audioInputs.supportedSampleRates
        ...
        let caps = AkAudioCaps.create(audioInputs.preferredFormat)
        ...
        sldLatency.value = audioInputs.latency

        cbxSampleFormats.forceActiveFocus()
    }
    ...
    ScrollView {
        ...
        GridLayout {
            ...
            AK.LabeledComboBox {
                id: cbxSampleFormats
                /*: A sample represents the strength of the wave at a certain
                    time.
                ...
                function reset()
                {
                    ...
                    currentIndex =
                            bound(0,
                                  audioInputs.supportedFormats.indexOf(caps.format),
                                  model.count - 1)
                }
            }
            AK.LabeledComboBox {
                ...
                function reset()
                {
                    ...
                    currentIndex =
                            bound(0,
                                  audioInputs.supportedChannelLayouts.indexOf(caps.layout),
                                  model.count - 1)
                }
            }
            AK.LabeledComboBox {
                ...
                function reset()
                {
                    ...
                    currentIndex =
                            bound(0,
                                  audioInputs.supportedSampleRates.indexOf(caps.rate),
                                  model.count - 1)
                }
            }
            Label {
    ...
    onAccepted: {
        ...
        let state = audioInputs.state
        audioInputs.state = AkElement.ElementStateNull
        audioInputs.deviceCaps = audioCaps
        audioInputs.latency = sldLatency.value
        audioInputs.state = state
    }
    onReset: {
