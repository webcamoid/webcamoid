...
Dialog {
    id: addEdit
    title: qsTr("Select the screen to add")
    ...
    onVisibleChanged: if (visible) cbxScreen.update()
            ...
            AK.LabeledComboBox {
                ...
                function update() {
                    ...
                    for (let screen in screens) {
                        let description = videoLayer.description(screens[screen])

                        model.append({
                            sourceId: screens[screen],
