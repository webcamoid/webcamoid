...
T.RoundButton {
    ...
    spacing: Ak.newUnit(12 * ThemeSettings.constrolScale, "dp").pixels
    hoverEnabled: true
    leftPadding:
        Ak.newUnit(16 * ThemeSettings.constrolScale, "dp").pixels
    rightPadding:
        Ak.newUnit(16 * ThemeSettings.constrolScale, "dp").pixels
    radius: Ak.newUnit(28 * ThemeSettings.constrolScale, "dp").pixels
    ...
    background: Item {
        ...
        DropShadow {
            ...
            anchors.fill: parent
            cached: true
            horizontalOffset: Ak.newUnit(3 * ThemeSettings.constrolScale, "dp").pixels
            verticalOffset: Ak.newUnit(3 * ThemeSettings.constrolScale, "dp").pixels
    ...
    states: [
        ...
        State {
            ...
            PropertyChanges {
                ...
                border.width:
                    roundButton.checkable?
                        Ak.newUnit(2 * ThemeSettings.constrolScale,
                                                  "dp").pixels:
                        Ak.newUnit(0 * ThemeSettings.constrolScale,
                                                  "dp").pixels
                visible: true
            }
            PropertyChanges {
                target: buttonShadow
                radius: Ak.newUnit(12 * ThemeSettings.constrolScale, "dp").pixels
            }
        }
    ]
