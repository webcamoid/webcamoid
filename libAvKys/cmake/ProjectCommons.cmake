...
set(APP_IDENTIFIER "io.github.webcamoid.Webcamoid" CACHE STRING "Application identifier")
...
if (ANDROID)
    set(NOSCREENCAPTURE_DEFAULT ON)
else ()
    set(NOSCREENCAPTURE_DEFAULT OFF)
endif ()

set(NOSCREENCAPTURE ${NOSCREENCAPTURE_DEFAULT} CACHE BOOL "Disable screen capture")
