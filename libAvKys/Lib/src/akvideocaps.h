...
class AKCOMMONS_EXPORT AkVideoCaps: public QObject
{
    ...
    public:
        enum PixelFormat
        {
            ...
            Format_xbgrpackbe      = AK_MAKE_FOURCC_BE('X', 'B', 'G', 'Q'),
            Format_xbgrpackle      = AK_MAKE_FOURCC_LE('X', 'B', 'G', 'Q'),
            ...
            Format_xrgbpackbe      = AK_MAKE_FOURCC_BE('X', 'R', 'G', 'Q'),
            Format_xrgbpackle      = AK_MAKE_FOURCC_LE('X', 'R', 'G', 'Q'),
            ...
            Format_abgrpackbe      = AK_MAKE_FOURCC_BE('A', 'B', 'G', 'Q'),
            Format_abgrpackle      = AK_MAKE_FOURCC_LE('A', 'B', 'G', 'Q'),
            ...
            Format_argbpackbe      = AK_MAKE_FOURCC_BE('A', 'R', 'G', 'Q'),
            Format_argbpackle      = AK_MAKE_FOURCC_LE('A', 'R', 'G', 'Q'),
            Format_ayuv            = AK_MAKE_FOURCC('A', 'Y', 'U', 'V'),
            Format_ayuv64be        = AK_MAKE_FOURCC_BE('A', 'Y', 'U', 64),
            Format_ayuv64le        = AK_MAKE_FOURCC_LE('A', 'Y', 'U', 64),
            Format_ayuvpackbe      = AK_MAKE_FOURCC_BE('A', 'Y', 'U', 'Q'),
            Format_ayuvpackle      = AK_MAKE_FOURCC_LE('A', 'Y', 'U', 'Q'),
            Format_bgrx            = AK_MAKE_FOURCC('B', 'G', 'R', 'X'),
            Format_bgrxpackbe      = AK_MAKE_FOURCC_BE('B', 'G', 'X', 'Q'),
            Format_bgrxpackle      = AK_MAKE_FOURCC_LE('B', 'G', 'X', 'Q'),
            ...
            Format_bgrapackbe      = AK_MAKE_FOURCC_BE('B', 'G', 'A', 'Q'),
            Format_bgrapackle      = AK_MAKE_FOURCC_LE('B', 'G', 'A', 'Q'),
            ...
            Format_gray10be        = AK_MAKE_FOURCC_BE('Y', 10, 0, 0),
            Format_gray10le        = AK_MAKE_FOURCC_LE('Y', 10, 0, 0),
            Format_gray12be        = AK_MAKE_FOURCC_BE('Y', 12, 0, 0),
            Format_gray12le        = AK_MAKE_FOURCC_LE('Y', 12, 0, 0),
            Format_gray14be        = AK_MAKE_FOURCC_BE('Y', 14, 0, 0),
            Format_gray14le        = AK_MAKE_FOURCC_LE('Y', 14, 0, 0),
            Format_gray16be        = AK_MAKE_FOURCC_BE('Y', 16, 0, 0),
            Format_gray16le        = AK_MAKE_FOURCC_LE('Y', 16, 0, 0),
            Format_gray32be        = AK_MAKE_FOURCC_BE('Y', 32, 0, 0),
            Format_gray32le        = AK_MAKE_FOURCC_LE('Y', 32, 0, 0),
            Format_gray4           = AK_MAKE_FOURCC('Y', 4, 0, 0),
            Format_gray6           = AK_MAKE_FOURCC('Y', 6, 0, 0),
            Format_gray8           = AK_MAKE_FOURCC('Y', 8, 0, 0),
            Format_gray9be         = AK_MAKE_FOURCC_BE('Y', 9, 0, 0),
            Format_gray9le         = AK_MAKE_FOURCC_LE('Y', 9, 0, 0),
            Format_graya16be       = AK_MAKE_FOURCC_BE('Y', 'A', 16, 0),
            Format_graya16le       = AK_MAKE_FOURCC_LE('Y', 'A', 16, 0),
            Format_graya8          = AK_MAKE_FOURCC('Y', 'A', 8, 0),
            Format_graya8packbe    = AK_MAKE_FOURCC_BE('Y', 'A', 8, 'Q'),
            Format_graya8packle    = AK_MAKE_FOURCC_LE('Y', 'A', 8, 'Q'),
            ...
            Format_rgbxpackbe      = AK_MAKE_FOURCC_BE('R', 'G', 'X', 'Q'),
            Format_rgbxpackle      = AK_MAKE_FOURCC_LE('R', 'G', 'X', 'Q'),
            ...
            Format_rgbapackbe      = AK_MAKE_FOURCC_BE('R', 'G', 'A', 'Q'),
            Format_rgbapackle      = AK_MAKE_FOURCC_LE('R', 'G', 'A', 'Q'),
            ...
            Format_yuv444packbe    = AK_MAKE_FOURCC_BE('Y', 'U', 4, 44),
            Format_yuv444packle    = AK_MAKE_FOURCC_LE('Y', 'U', 4, 44),
            Format_yuv555packbe    = AK_MAKE_FOURCC_BE('Y', 'U', 5, 55),
            Format_yuv555packle    = AK_MAKE_FOURCC_LE('Y', 'U', 5, 55),
            Format_yuv565packbe    = AK_MAKE_FOURCC_BE('Y', 'U', 5, 65),
            Format_yuv565packle    = AK_MAKE_FOURCC_LE('Y', 'U', 5, 65),
