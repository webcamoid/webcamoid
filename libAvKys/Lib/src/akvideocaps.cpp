    ...
    public:
        ...
        static inline const QVector<VideoFormat> &formats()
        {
            static const QVector<VideoFormat> videoFormats = {
                ...
                {AkVideoCaps::Format_bayer_bggr8,      8, AkFourCC(-70, 'B', 'G', 8)},
                {AkVideoCaps::Format_bayer_rggb8,      8, AkFourCC(-70, 'R', 'G', 8)},
                {AkVideoCaps::Format_bayer_gbrg8,      8, AkFourCC(-70, 'G', 'B', 8)},
                {AkVideoCaps::Format_bayer_grbg8,      8, AkFourCC(-70, 'G', 'R', 8)},
                {AkVideoCaps::Format_bayer_bggr16le,  16, AkFourCC(-70, 'B', 'G', 16)},
                {AkVideoCaps::Format_bayer_bggr16be,  16, AkFourCC(16, 'G', 'B', -70)},
                {AkVideoCaps::Format_bayer_rggb16le,  16, AkFourCC(-70, 'R', 'G', 16)},
                {AkVideoCaps::Format_bayer_rggb16be,  16, AkFourCC(16, 'G', 'R', -70)},
                {AkVideoCaps::Format_bayer_gbrg16le,  16, AkFourCC(-70, 'G', 'B', 16)},
                {AkVideoCaps::Format_bayer_gbrg16be,  16, AkFourCC(16, 'B', 'G', -70)},
                {AkVideoCaps::Format_bayer_grbg16le,  16, AkFourCC(-70, 'G', 'R', 16)},
                {AkVideoCaps::Format_bayer_grbg16be,  16, AkFourCC(16, 'R', 'G', -70)},
