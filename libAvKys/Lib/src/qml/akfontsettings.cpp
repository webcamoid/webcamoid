    ...
    QObject(parent)
{
    ...
    this->d->m_h1 = font;
    this->d->m_h1.setPointSize(96 * pointSize / 16);
    this->d->m_h1.setWeight(QFont::Light);
    this->d->m_h2 = font;
    this->d->m_h2.setPointSize(60 * pointSize / 16);
    this->d->m_h2.setWeight(QFont::Light);
    this->d->m_h3 = font;
    this->d->m_h3.setPointSize(48 * pointSize / 16);
    this->d->m_h3.setWeight(QFont::Normal);
    this->d->m_h4 = font;
    this->d->m_h4.setPointSize(34 * pointSize / 16);
    this->d->m_h4.setWeight(QFont::Normal);
    this->d->m_h5 = font;
    this->d->m_h5.setPointSize(24 * pointSize / 16);
    this->d->m_h5.setWeight(QFont::Normal);
    this->d->m_h6 = font;
    this->d->m_h6.setPointSize(20 * pointSize / 16);
    this->d->m_h6.setWeight(QFont::Medium);
    this->d->m_subtitle1 = font;
    this->d->m_subtitle1.setPointSize(16 * pointSize / 16);
    this->d->m_subtitle1.setWeight(QFont::Normal);
    this->d->m_subtitle2 = font;
    this->d->m_subtitle2.setPointSize(14 * pointSize / 16);
    this->d->m_subtitle2.setWeight(QFont::Medium);
    this->d->m_body1 = font;
    this->d->m_body1.setPointSize(16 * pointSize / 16);
    this->d->m_body1.setWeight(QFont::Normal);
    this->d->m_body2 = font;
    this->d->m_body2.setPointSize(14 * pointSize / 16);
    this->d->m_body2.setWeight(QFont::Normal);
    this->d->m_button = font;
    this->d->m_button.setPointSize(16 * pointSize / 16);
    this->d->m_button.setWeight(QFont::Medium);
    this->d->m_caption = font;
    this->d->m_caption.setPointSize(12 * pointSize / 16);
    this->d->m_caption.setWeight(QFont::Normal);
    this->d->m_overline = font;
    this->d->m_overline.setPointSize(10 * pointSize / 16);
    this->d->m_overline.setWeight(QFont::Normal);
}
