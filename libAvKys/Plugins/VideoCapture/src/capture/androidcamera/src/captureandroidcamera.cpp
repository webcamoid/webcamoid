...
inline const ControlVector &initImageControls()
{
    static const ControlVector controls {
        ...
        {REQUEST_KEY_BOOLEAN(CONTROL_AE_LOCK)                 , "Auto Exposure Lock"        , ControlType::Boolean, CHARACTERISTICS_VALUE(CONTROL_AE_LOCK_AVAILABLE)    , {}                                                 , CONTROL_VALUE_NUM(true)                           , {}                                                                , {}                  },
        ...
        {REQUEST_KEY_BOOLEAN(CONTROL_AWB_LOCK)                , "Auto White Balance Lock"   , ControlType::Boolean, CHARACTERISTICS_VALUE(CONTROL_AWB_LOCK_AVAILABLE)   , {}                                                 , CONTROL_VALUE_NUM(true)                           , {}                                                                , {}                  },
