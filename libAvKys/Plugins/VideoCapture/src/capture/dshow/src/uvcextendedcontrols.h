...
class UvcExtendedControls: public QObject
{
    ...
    public:
        ...
        UvcExtendedControls(IBaseFilter *filter);
        ~UvcExtendedControls();
        void load(const QString &devicePath);
        void load(IBaseFilter *filter);
        QVariantList controls(IBaseFilter *filter) const;
        QVariantList controls(const QString &devicePath) const;
        bool setControls(IBaseFilter *filter, const QVariantMap &controls) const;
