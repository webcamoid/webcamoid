...
inline SpaFmtToAkFmtMap initSpaFmtToAkFmt()
{
    SpaFmtToAkFmtMap spaFmtToAkFmt {
        ...
        {SPA_VIDEO_FORMAT_GRAY8     , AkVideoCaps::Format_gray8        },
        {SPA_VIDEO_FORMAT_GRAY16_BE , AkVideoCaps::Format_gray16be     },
        {SPA_VIDEO_FORMAT_GRAY16_LE , AkVideoCaps::Format_gray16le     },
...
const spa_pod *CapturePipeWirePrivate::buildFormat(spa_pod_builder *podBuilder,
                                                   ...
                                                   const AkFrac &fps) const
{
    auto &widthRange = this->m_widthRange[this->m_curDevice];
    auto &heightRange = this->m_heightRange[this->m_curDevice];
    auto &fpsRange = this->m_frameRateRange[this->m_curDevice];
