...
OpacityElement::OpacityElement(): AkVideoEffect()
{
...
void OpacityElement::process(QOpenGLFramebufferObject *inputFbo,
                             ...
                             qreal pts)
{
    ...
    this->d->m_shader->setUniformValue("uOpacity", float(this->d->m_opacity));
