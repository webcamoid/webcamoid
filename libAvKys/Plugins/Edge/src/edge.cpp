...
class EdgePrivate
{
    public:
        Edge *self {nullptr};
        QString m_description {QObject::tr("Edges")};
        ...
        explicit EdgePrivate(Edge *self);
...
QString Edge::description() const
{
    return this->d->m_description;
}

AkElementType Edge::type() const
{
    return this->d->m_type;
}

AkElementCategory Edge::category() const
{
    return this->d->m_category;
}

void *Edge::queryInterface(const QString &interfaceId)
{
...
IAkElement *Edge::create(const QString &id)
{
    Q_UNUSED(id)
...
int Edge::registerElements(const QStringList &args)
{
    QString pluginPath;
    ...
    AkPluginInfo pluginInfo("VideoFilter/Edge",
...
bool Edge::canny() const
{
    return this->d->m_canny;
}

int Edge::thLow() const
{
...
bool Edge::equalize() const
{
    return this->d->m_equalize;
}

bool Edge::invert() const
{
    return this->d->m_invert;
}

void Edge::deleteThis(void *userData) const
{
    delete reinterpret_cast<Edge *>(userData);
}

QString Edge::controlInterfaceProvide(const QString &controlId) const
{
    Q_UNUSED(controlId)
...
void Edge::controlInterfaceConfigure(QQmlContext *context,
...
AkPacket Edge::iVideoStream(const AkVideoPacket &packet)
{
...
void Edge::setEqualize(bool equalize)
{
...
void Edge::setInvert(bool invert)
{
...
void Edge::resetCanny()
{
    this->setCanny(false);
}

void Edge::resetThLow()
{
    this->setThLow(510);
}
...
void Edge::resetEqualize()
{
    this->setEqualize(false);
}

void Edge::resetInvert()
{
    this->setInvert(false);
}

EdgePrivate::EdgePrivate(Edge *self):
    self(self)
{

}

AkVideoPacket EdgePrivate::equalize(const AkVideoPacket &src)
{
    AkVideoPacket dst(src.caps());
    dst.copyMetadata(src);
    int minGray = 255;
...
void EdgePrivate::sobel(const AkVideoPacket &gray,
                               AkVideoPacket &gradient,
                               AkVideoPacket &direction) const
{
    auto caps = gray.caps();
...
AkVideoPacket EdgePrivate::thinning(const AkVideoPacket &gradient,
                                           const AkVideoPacket &direction) const
{
...
AkVideoPacket EdgePrivate::threshold(const AkVideoPacket &thinned,
                                            const QVector<int> &thresholds,
                                            const QVector<int> &map) const
{
...
AkVideoPacket EdgePrivate::hysteresisThresholding(const AkVideoPacket &thresholded) const
{
...
void EdgePrivate::trace(AkVideoPacket &canny, int x, int y) const
{
