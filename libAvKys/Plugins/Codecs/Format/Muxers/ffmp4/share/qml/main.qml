...
GridLayout {
    ...
    TextField {
        ...
        onTextChanged: VideoMuxerFFMp4.bitrate = Number(text)
    }
    Label {
        id: txtGOP
    ...
    TextField {
        ...
        onTextChanged: VideoMuxerFFMp4.gop = Number(text)
    }
    GroupBox {
    ...
    RowLayout {
        ...
        ComboBox {
            ...
            textRole: "text"
            currentIndex: VideoMuxerFFMp4.deadline == VideoMuxerFFMp4.Deadline_Realtime?
                                0:
                          VideoMuxerFFMp4.deadline == VideoMuxerFFMp4.Deadline_GoodQuality?
                                1:
                          VideoMuxerFFMp4.deadline == VideoMuxerFFMp4.Deadline_BestQuality?
                                2:
            ...
            model: ListModel {
                ListElement {
                    text: qsTr("Realtime")
                    deadline: VideoMuxerFFMp4.Deadline_Realtime
                }
                ListElement {
                    text: qsTr("Good quality")
                    deadline: VideoMuxerFFMp4.Deadline_GoodQuality
                }
                ListElement {
                    text: qsTr("Best quality")
                    deadline: VideoMuxerFFMp4.Deadline_BestQuality
                }
                ListElement {
                    text: qsTr("Custom")
                    deadline: VideoMuxerFFMp4.Deadline_Realtime
            ...
            onCurrentIndexChanged: VideoMuxerFFMp4.deadline = model.get(currentIndex).deadline
        }
        TextField {
            text: VideoMuxerFFMp4.deadline
            ...
            onTextChanged: VideoMuxerFFMp4.deadline = Number(text)
        }
    }
}
