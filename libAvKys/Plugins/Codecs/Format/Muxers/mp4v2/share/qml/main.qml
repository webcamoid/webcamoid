...
GridLayout {
    ...
    TextField {
        ...
        onTextChanged: VideoMuxerMp4V2.bitrate = Number(text)
    }
    Label {
        id: txtGOP
    ...
    TextField {
        ...
        onTextChanged: VideoMuxerMp4V2.gop = Number(text)
    }
    GroupBox {
    ...
    RowLayout {
        ...
        ComboBox {
            ...
            textRole: "text"
            currentIndex: VideoMuxerMp4V2.deadline == VideoMuxerMp4V2.Deadline_Realtime?
                                0:
                          VideoMuxerMp4V2.deadline == VideoMuxerMp4V2.Deadline_GoodQuality?
                                1:
                          VideoMuxerMp4V2.deadline == VideoMuxerMp4V2.Deadline_BestQuality?
                                2:
            ...
            model: ListModel {
                ListElement {
                    text: qsTr("Realtime")
                    deadline: VideoMuxerMp4V2.Deadline_Realtime
                }
                ListElement {
                    text: qsTr("Good quality")
                    deadline: VideoMuxerMp4V2.Deadline_GoodQuality
                }
                ListElement {
                    text: qsTr("Best quality")
                    deadline: VideoMuxerMp4V2.Deadline_BestQuality
                }
                ListElement {
                    text: qsTr("Custom")
                    deadline: VideoMuxerMp4V2.Deadline_Realtime
            ...
            onCurrentIndexChanged: VideoMuxerMp4V2.deadline = model.get(currentIndex).deadline
        }
        TextField {
            text: VideoMuxerMp4V2.deadline
            ...
            onTextChanged: VideoMuxerMp4V2.deadline = Number(text)
        }
    }
}
