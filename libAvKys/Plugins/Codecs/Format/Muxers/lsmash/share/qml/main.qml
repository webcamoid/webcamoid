...
GridLayout {
    ...
    TextField {
        ...
        onTextChanged: VideoMuxerLSmash.bitrate = Number(text)
    }
    Label {
        id: txtGOP
    ...
    TextField {
        ...
        onTextChanged: VideoMuxerLSmash.gop = Number(text)
    }
    GroupBox {
    ...
    RowLayout {
        ...
        ComboBox {
            ...
            textRole: "text"
            currentIndex: VideoMuxerLSmash.deadline == VideoMuxerLSmash.Deadline_Realtime?
                                0:
                          VideoMuxerLSmash.deadline == VideoMuxerLSmash.Deadline_GoodQuality?
                                1:
                          VideoMuxerLSmash.deadline == VideoMuxerLSmash.Deadline_BestQuality?
                                2:
            ...
            model: ListModel {
                ListElement {
                    text: qsTr("Realtime")
                    deadline: VideoMuxerLSmash.Deadline_Realtime
                }
                ListElement {
                    text: qsTr("Good quality")
                    deadline: VideoMuxerLSmash.Deadline_GoodQuality
                }
                ListElement {
                    text: qsTr("Best quality")
                    deadline: VideoMuxerLSmash.Deadline_BestQuality
                }
                ListElement {
                    text: qsTr("Custom")
                    deadline: VideoMuxerLSmash.Deadline_Realtime
            ...
            onCurrentIndexChanged: VideoMuxerLSmash.deadline = model.get(currentIndex).deadline
        }
        TextField {
            text: VideoMuxerLSmash.deadline
            ...
            onTextChanged: VideoMuxerLSmash.deadline = Number(text)
        }
    }
}
