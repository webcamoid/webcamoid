...
GridLayout {
    ...
    TextField {
        ...
        onTextChanged: VideoMuxerFFWebm.bitrate = Number(text)
    }
    Label {
        id: txtGOP
    ...
    TextField {
        ...
        onTextChanged: VideoMuxerFFWebm.gop = Number(text)
    }
    GroupBox {
    ...
    RowLayout {
        ...
        ComboBox {
            ...
            textRole: "text"
            currentIndex: VideoMuxerFFWebm.deadline == VideoMuxerFFWebm.Deadline_Realtime?
                                0:
                          VideoMuxerFFWebm.deadline == VideoMuxerFFWebm.Deadline_GoodQuality?
                                1:
                          VideoMuxerFFWebm.deadline == VideoMuxerFFWebm.Deadline_BestQuality?
                                2:
            ...
            model: ListModel {
                ListElement {
                    text: qsTr("Realtime")
                    deadline: VideoMuxerFFWebm.Deadline_Realtime
                }
                ListElement {
                    text: qsTr("Good quality")
                    deadline: VideoMuxerFFWebm.Deadline_GoodQuality
                }
                ListElement {
                    text: qsTr("Best quality")
                    deadline: VideoMuxerFFWebm.Deadline_BestQuality
                }
                ListElement {
                    text: qsTr("Custom")
                    deadline: VideoMuxerFFWebm.Deadline_Realtime
            ...
            onCurrentIndexChanged: VideoMuxerFFWebm.deadline = model.get(currentIndex).deadline
        }
        TextField {
            text: VideoMuxerFFWebm.deadline
            ...
            onTextChanged: VideoMuxerFFWebm.deadline = Number(text)
        }
    }
}
