...
#ifndef VIDEOMUXERFFWEBMELEMENT_H
#define VIDEOMUXERFFWEBMELEMENT_H

#include <iak/akvideomuxer.h>

class VideoMuxerFFWebmElementPrivate;

class VideoMuxerFFWebmElement: public AkVideoMuxer
{
    Q_OBJECT

    public:
        VideoMuxerFFWebmElement();
        ~VideoMuxerFFWebmElement();
    ...
    private:
        VideoMuxerFFWebmElementPrivate *d;
...
#endif // VIDEOMUXERFFWEBMELEMENT_H
