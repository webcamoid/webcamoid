...
GridLayout {
    ...
    TextField {
        ...
        onTextChanged: VideoEncoderX264.bitrate = Number(text)
    }
    Label {
        id: txtGOP
    ...
    TextField {
        ...
        onTextChanged: VideoEncoderX264.gop = Number(text)
    }
    GroupBox {
    ...
    RowLayout {
        ...
        ComboBox {
            ...
            textRole: "text"
            currentIndex: VideoEncoderX264.deadline == VideoEncoderX264.Deadline_Realtime?
                                0:
                          VideoEncoderX264.deadline == VideoEncoderX264.Deadline_GoodQuality?
                                1:
                          VideoEncoderX264.deadline == VideoEncoderX264.Deadline_BestQuality?
                                2:
            ...
            model: ListModel {
                ListElement {
                    text: qsTr("Realtime")
                    deadline: VideoEncoderX264.Deadline_Realtime
                }
                ListElement {
                    text: qsTr("Good quality")
                    deadline: VideoEncoderX264.Deadline_GoodQuality
                }
                ListElement {
                    text: qsTr("Best quality")
                    deadline: VideoEncoderX264.Deadline_BestQuality
                }
                ListElement {
                    text: qsTr("Custom")
                    deadline: VideoEncoderX264.Deadline_Realtime
            ...
            onCurrentIndexChanged: VideoEncoderX264.deadline = model.get(currentIndex).deadline
        }
        TextField {
            text: VideoEncoderX264.deadline
            ...
            onTextChanged: VideoEncoderX264.deadline = Number(text)
        }
    }
}
