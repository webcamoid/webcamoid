...
GridLayout {
    ...
    TextField {
        text: VideoEncoderFFX264.bitrate
        ...
        onTextChanged: VideoEncoderFFX264.bitrate = Number(text)
    }
    Label {
        id: txtGOP
    ...
    TextField {
        ...
        onTextChanged: VideoEncoderFFX264.gop = Number(text)
    }
    GroupBox {
    ...
    RowLayout {
        ...
        ComboBox {
            ...
            textRole: "text"
            currentIndex: VideoEncoderFFX264.deadline == VideoEncoderFFX264.Deadline_Realtime?
                                0:
                          VideoEncoderFFX264.deadline == VideoEncoderFFX264.Deadline_GoodQuality?
                                1:
                          VideoEncoderFFX264.deadline == VideoEncoderFFX264.Deadline_BestQuality?
                                2:
            ...
            model: ListModel {
                ListElement {
                    text: qsTr("Realtime")
                    deadline: VideoEncoderFFX264.Deadline_Realtime
                }
                ListElement {
                    text: qsTr("Good quality")
                    deadline: VideoEncoderFFX264.Deadline_GoodQuality
                }
                ListElement {
                    text: qsTr("Best quality")
                    deadline: VideoEncoderFFX264.Deadline_BestQuality
                }
                ListElement {
                    text: qsTr("Custom")
                    deadline: VideoEncoderFFX264.Deadline_Realtime
            ...
            onCurrentIndexChanged: VideoEncoderFFX264.deadline = model.get(currentIndex).deadline
        }
        TextField {
            text: VideoEncoderFFX264.deadline
            ...
            onTextChanged: VideoEncoderFFX264.deadline = Number(text)
        }
    }
}
