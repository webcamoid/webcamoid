...
class  VideoEncoderFFmpegElement: public AkVideoEncoder
{
    ...
    Q_PROPERTY(QStringList encoders
               READ encoders
               CONSTANT)
    Q_PROPERTY(QString encoder
               READ encoder
               WRITE setEncoder
               RESET resetEncoder
               NOTIFY encoderChanged)
    ...
    public:
        ...
        Q_INVOKABLE QStringList encoders() const;
        Q_INVOKABLE QString encoder() const;
        Q_INVOKABLE QString encoderDescription(const QString &encoder) const;
