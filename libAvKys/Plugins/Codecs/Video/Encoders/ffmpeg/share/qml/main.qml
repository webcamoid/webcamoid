...
GridLayout {
    ...
    TextField {
        text: VideoEncoderFFmpeg.bitrate
        ...
        onTextChanged: VideoEncoderFFmpeg.bitrate = Number(text)
    }
    Label {
        id: txtGOP
    ...
    TextField {
        ...
        onTextChanged: VideoEncoderFFmpeg.gop = Number(text)
    }
    GroupBox {
    ...
    RowLayout {
        ...
        ComboBox {
            ...
            textRole: "text"
            currentIndex: VideoEncoderFFmpeg.deadline == VideoEncoderFFmpeg.Deadline_Realtime?
                                0:
                          VideoEncoderFFmpeg.deadline == VideoEncoderFFmpeg.Deadline_GoodQuality?
                                1:
                          VideoEncoderFFmpeg.deadline == VideoEncoderFFmpeg.Deadline_BestQuality?
                                2:
            ...
            model: ListModel {
                ListElement {
                    text: qsTr("Realtime")
                    deadline: VideoEncoderFFmpeg.Deadline_Realtime
                }
                ListElement {
                    text: qsTr("Good quality")
                    deadline: VideoEncoderFFmpeg.Deadline_GoodQuality
                }
                ListElement {
                    text: qsTr("Best quality")
                    deadline: VideoEncoderFFmpeg.Deadline_BestQuality
                }
                ListElement {
                    text: qsTr("Custom")
                    deadline: VideoEncoderFFmpeg.Deadline_Realtime
            ...
            onCurrentIndexChanged: VideoEncoderFFmpeg.deadline = model.get(currentIndex).deadline
        }
        TextField {
            text: VideoEncoderFFmpeg.deadline
            ...
            onTextChanged: VideoEncoderFFmpeg.deadline = Number(text)
        }
    }
}
