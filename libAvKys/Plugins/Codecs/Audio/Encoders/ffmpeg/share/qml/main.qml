...
GridLayout {
    ...
    TextField {
        text: AudioEncoderFFmpeg.bitrate
        ...
        onTextChanged: AudioEncoderFFmpeg.bitrate = Number(text)
    }
    Label {
        id: txtGOP
    ...
    TextField {
        ...
        onTextChanged: AudioEncoderFFmpeg.gop = Number(text)
    }
    GroupBox {
    ...
    RowLayout {
        ...
        ComboBox {
            ...
            textRole: "text"
            currentIndex: AudioEncoderFFmpeg.deadline == AudioEncoderFFmpeg.Deadline_Realtime?
                                0:
                          AudioEncoderFFmpeg.deadline == AudioEncoderFFmpeg.Deadline_GoodQuality?
                                1:
                          AudioEncoderFFmpeg.deadline == AudioEncoderFFmpeg.Deadline_BestQuality?
                                2:
            ...
            model: ListModel {
                ListElement {
                    text: qsTr("Realtime")
                    deadline: AudioEncoderFFmpeg.Deadline_Realtime
                }
                ListElement {
                    text: qsTr("Good quality")
                    deadline: AudioEncoderFFmpeg.Deadline_GoodQuality
                }
                ListElement {
                    text: qsTr("Best quality")
                    deadline: AudioEncoderFFmpeg.Deadline_BestQuality
                }
                ListElement {
                    text: qsTr("Custom")
                    deadline: AudioEncoderFFmpeg.Deadline_Realtime
            ...
            onCurrentIndexChanged: AudioEncoderFFmpeg.deadline = model.get(currentIndex).deadline
        }
        TextField {
            text: AudioEncoderFFmpeg.deadline
            ...
            onTextChanged: AudioEncoderFFmpeg.deadline = Number(text)
        }
    }
}
