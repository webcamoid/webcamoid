...
Q_DECL_EXPORT QDataStream &operator >>(QDataStream &istream, FaceDetect::MarkerType &markerType);
Q_DECL_EXPORT QDataStream &operator <<(QDataStream &ostream, FaceDetect::MarkerType markerType);

Q_DECLARE_METATYPE(FaceDetect::MarkerType)
