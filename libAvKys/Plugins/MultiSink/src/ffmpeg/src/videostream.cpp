...
struct PixelFormat
{
    ...
    AkVideoCaps::PixelFormat akFormat;

    static inline const PixelFormat *byFF(AVPixelFormat ffFormat);
    static inline const PixelFormat *byAk(AkVideoCaps::PixelFormat akFormat);
};

static const PixelFormat multiSinkPixelFormatTable[] {
...
const PixelFormat *PixelFormat::byFF(AVPixelFormat ffFormat)
{
    auto fmt = multiSinkPixelFormatTable;

    for (; fmt->akFormat != AkVideoCaps::Format_none; fmt++)
...
const PixelFormat *PixelFormat::byAk(AkVideoCaps::PixelFormat akFormat)
{
    auto fmt = multiSinkPixelFormatTable;
                   ...
                   parent)
{
    ...
    codecContext->pix_fmt = PixelFormat::byAk(videoCaps.format())->ffFormat;
...
{
    return PixelFormat::byFF(format)->akFormat;
}
