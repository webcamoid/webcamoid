...
#ifndef MULTISINKELEMENTSETTINGS_H
#define MULTISINKELEMENTSETTINGS_H

#include <QObject>

class MultiSinkElementSettings: public QObject
{
    Q_OBJECT
    ...
    public:
        MultiSinkElementSettings(QObject *parent=nullptr);
...
#endif // MULTISINKELEMENTSETTINGS_H
