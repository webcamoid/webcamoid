...
class ZoomPrivate
{
    public:
        Zoom *self {nullptr};
        QString m_description {QObject::tr("Zoom")};
        ...
        explicit ZoomPrivate(Zoom *self);
...
QString Zoom::description() const
{
    return this->d->m_description;
}

AkElementType Zoom::type() const
{
    return this->d->m_type;
}

AkElementCategory Zoom::category() const
{
    return this->d->m_category;
}

void *Zoom::queryInterface(const QString &interfaceId)
{
...
IAkElement *Zoom::create(const QString &id)
{
    Q_UNUSED(id)
...
int Zoom::registerElements(const QStringList &args)
{
    QString pluginPath;
    ...
    AkPluginInfo pluginInfo("VideoFilter/Zoom",
...
qreal Zoom::zoom() const
{
    return this->d->m_zoom;
}

void Zoom::deleteThis(void *userData) const
{
    delete reinterpret_cast<Zoom *>(userData);
}

QString Zoom::controlInterfaceProvide(const QString &controlId) const
{
    Q_UNUSED(controlId)
...
void Zoom::controlInterfaceConfigure(QQmlContext *context,
...
AkPacket Zoom::iVideoStream(const AkVideoPacket &packet)
{
    if (!packet)
        return {};
...
ZoomPrivate::ZoomPrivate(Zoom *self):
      self(self)
{

}

void ZoomPrivate::clearBuffers()
{
...
void ZoomPrivate::allocateBuffers(const AkVideoCaps &caps)
{
    this->clearBuffers();
...
void ZoomPrivate::configure(const AkVideoCaps &caps)
{
...
void ZoomPrivate::configureScaling(const AkVideoCaps &caps, qreal zoom)
{
