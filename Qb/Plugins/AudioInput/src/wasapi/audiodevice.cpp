...
inline SampleFormatsMap initSampleFormatsMap()
{
    ...
    sampleFormats[QString("%1_%2").arg(WAVE_FORMAT_PCM).arg(8)] = QbAudioCaps::SampleFormat_u8;
    sampleFormats[QString("%1_%2").arg(WAVE_FORMAT_PCM).arg(16)] = QbAudioCaps::SampleFormat_s16;
    sampleFormats[QString("%1_%2").arg(WAVE_FORMAT_PCM).arg(32)] = QbAudioCaps::SampleFormat_s32;
    sampleFormats[QString("%1_%2").arg(WAVE_FORMAT_IEEE_FLOAT).arg(32)] = QbAudioCaps::SampleFormat_flt;
                                  ...
                                  int *sampleRate)
{
    ...
    if (!isActivated)
        if (!this->init(mode, QbAudioCaps::SampleFormat_none, 0, 0, true))
            return false;
    ...
    *sampleFormat = sampleFormats->value(fmtStr, QbAudioCaps::SampleFormat_u8);
