...
isEmpty(COMMONS_PRI_INCLUDE) {
    ...
    unix {
        ...
        COMMONS_APP_PLUGINS_INSTALL_PATH_SYSTEM = $${INSTALLPREFIX}/lib/$${COMMONS_TARGET}
        COMMONS_APP_TR_INSTALL_PATH = $${COMMONS_APP_DATA_INSTALL_PATH}/tr
        COMMONS_APP_TR_INSTALL_PATH_SYSTEM = $${INSTALLPREFIX}/share/$${COMMONS_TARGET}/tr
    ...
    DEFINES += \
        ...
        COMMONS_APP_PLUGINS_INSTALL_PATH_SYSTEM=\"\\\"$$COMMONS_APP_PLUGINS_INSTALL_PATH_SYSTEM\\\"\" \
        COMMONS_APP_TR_INSTALL_PATH=\"\\\"$$COMMONS_APP_TR_INSTALL_PATH\\\"\" \
        COMMONS_APP_TR_INSTALL_PATH_SYSTEM=\"\\\"$$COMMONS_APP_TR_INSTALL_PATH_SYSTEM\\\"\" \
