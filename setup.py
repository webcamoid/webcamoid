...
webcamoidGui = os.path.join(prefix, 'share/apps/plasma/plasmoids/Webcamoid/contents/code/webcamoidgui.py')
...
with open('Webcamoid.desktop', 'w') as desktopLauncher:
    desktopLauncher.write('[Desktop Entry]\n' \
                          'Encoding=UTF-8\n' \
                          'Name=Webcamoid\n' \
...
core.setup(
    ...
    version='3.1.0',
    license='GPLv3',
    requires=('ctypes', 'fcntl', 'os', 'platform', 'signal', 'subprocess', 'sys', 'PyQt4', 'PyKDE4'),
    ...
    data_files=[('share/apps/plasma/plasmoids/Webcamoid/contents/code', glob.glob('contents/code/*.py')),
                ('share/apps/plasma/plasmoids/Webcamoid/contents/code/v4l2', ['contents/code/v4l2/__init__.py', 'contents/code/v4l2/v4l2.py', 'contents/code/v4l2/LICENSE']),
                ('share/apps/plasma/plasmoids/Webcamoid/contents/ts', glob.glob('contents/ts/*.qm')),
                ('share/apps/plasma/plasmoids/Webcamoid/contents/ui', glob.glob('contents/ui/*.ui')),
